...
def print_results(char_count, file_count, error_files, top_n=50, show_spaces=False, save_csv=False):
...
def main():
    ...
    print_results(char_count, file_count, error_files, args.top, args.show_spaces, args.save_csv)
